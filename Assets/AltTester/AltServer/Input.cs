...
public class Input : MonoBehaviour
{
    ...
    private static System.Collections.Generic.List<KeyStructure> _keyCodesPressed =
        new System.Collections.Generic.List<KeyStructure>();

    private static System.Collections.Generic.List<KeyStructure> _keyCodesPressedDown =
        new System.Collections.Generic.List<KeyStructure>();

    private static System.Collections.Generic.List<KeyStructure> _keyCodesPressedUp =
        new System.Collections.Generic.List<KeyStructure>();

    private static System.Collections.Generic.Dictionary<int, PointerEventData> _pointerEventsDataDictionary =
        new System.Collections.Generic.Dictionary<int, PointerEventData>();

    private static System.Collections.Generic.Dictionary<int, int> _inputIdDictionary =
    ...
    private static readonly Dictionary<PointerEventData.InputButton, int> pointerIds =
        new Dictionary<PointerEventData.InputButton, int>
        {
    ...
    private static PointerEventData.InputButton[] mouseButtons =
    ...
    public static AltMockUpPointerInputModule AltMockUpPointerInputModule
    {
        get
        {
            if (_mockUpPointerInputModule == null)
            {
                ...
                {
                    _mockUpPointerInputModule =
                        EventSystem.current.gameObject.AddComponent<AltMockUpPointerInputModule>();
                }
                else
                {
    ...
    private void FixedUpdate()
    {
        ...
        {
            if (monoBehaviourPreviousTarget != null)
                monoBehaviourPreviousTarget.SendMessage("OnMouseExit",
                    UnityEngine.SendMessageOptions.DontRequireReceiver);
            if (monoBehaviourTarget != null && previousMousePosition != mousePosition)
                monoBehaviourTarget.SendMessage("OnMouseEnter", UnityEngine.SendMessageOptions.DontRequireReceiver);
        ...
        if (EventSystem.current.currentInputModule != null)
        {
            ...
            {
                if (previousEventSystemTarget != null)
                    UnityEngine.EventSystems.ExecuteEvents.ExecuteHierarchy(previousEventSystemTarget, pointerEventData,
                        UnityEngine.EventSystems.ExecuteEvents.pointerExitHandler);
                if (eventSystemTarget != null && previousMousePosition != mousePosition)
                    UnityEngine.EventSystems.ExecuteEvents.ExecuteHierarchy(eventSystemTarget, pointerEventData,
    ...
    public static float GetAxis(string axisName)
    {
        if (_useCustomInput)
        {
            ...
            {
                if ((axis.positiveButton != "" &&
                     keyStructure.KeyCode == ConvertStringToKeyCode(axis.positiveButton)) ||
    ...
    public static bool GetButton(string buttonName)
    {
        if (_useCustomInput)
        {
            ...
            foreach (var keyStructure in _keyCodesPressed)
            {
                ...
                if (keyStructure.KeyCode == ConvertStringToKeyCode(axis.negativeButton) ||
                    keyStructure.KeyCode == ConvertStringToKeyCode(axis.altNegativeButton))
                {
                    LastAxisName = axis.name; //Debug purpose
                    return true;
    ...
    public static bool GetMouseButtonDown(int button)
    {
        ...
        if (_useCustomInput)
        {
            var keyCode = (UnityEngine.KeyCode) System.Enum.Parse(typeof(UnityEngine.KeyCode), "Mouse" + button);
            return 0 != _keyCodesPressedDown.FindAll(key => key.KeyCode == keyCode).Count ||
                   (_touches.Length > button && _touches[button].phase == UnityEngine.TouchPhase.Began);
        }
        else
        {
    ...
    public static bool GetMouseButtonUp(int button)
    {
        ...
        {
            var keyCode = (UnityEngine.KeyCode) System.Enum.Parse(typeof(UnityEngine.KeyCode), "Mouse" + button);
            return 0 != _keyCodesPressedUp.FindAll(key => key.KeyCode == keyCode).Count || _touches.Length > button &&
                _touches[button].phase == UnityEngine.TouchPhase.Ended;
        }
        else
        {
    ...
    public static System.Collections.IEnumerator MultipointSwipeLifeCycle(UnityEngine.Vector2[] positions,
        float duration)
    {
        ...
        for (var i = 1; i < positions.Length; i++)
        {
            ...
            do
            {
                ...
                touch.phase = touch.deltaPosition != UnityEngine.Vector2.zero
    ...
    internal static System.Collections.IEnumerator ScrollLifeCycle(float scrollVertical, float scrollHorizontal,
        float duration)
    {
        float timeSpent = 0;
    ...
    internal static IEnumerator
        runThrowingIterator( //TODO Remove this method when all the input methods were implemented in InputController
    ...
    private static UnityEngine.GameObject findEventSystemObject(
    ...
    internal static IEnumerator tapClickCoordinatesLifeCycle(UnityEngine.Vector2 screenPosition, int count,
        float interval, bool tap)
    {
        var pointerEventData =
            new UnityEngine.EventSystems.PointerEventData(UnityEngine.EventSystems.EventSystem.current)
            {
        ...
        for (int i = 0; i < count; i++)
        {
            ...
            pointerEventData.pointerPress = UnityEngine.EventSystems.ExecuteEvents.ExecuteHierarchy(eventSystemTarget,
                pointerEventData, UnityEngine.EventSystems.ExecuteEvents.pointerDownHandler);
            ...
            if (monoBehaviourTarget != null)
            {
                ...
                monoBehaviourTarget.SendMessage("OnMouseUpAsButton",
                    UnityEngine.SendMessageOptions.DontRequireReceiver);
            }
        ...
        if (monoBehaviourTarget != null)
            monoBehaviourTarget.SendMessage("OnMouseExit", UnityEngine.SendMessageOptions.DontRequireReceiver);
    }

    internal static IEnumerator tapClickElementLifeCycle(UnityEngine.GameObject target, int count, float interval,
        bool tap)
    {
        ...
        for (int i = 0; i < count; i++)
        {
            ...
            UnityEngine.EventSystems.ExecuteEvents.Execute(target, pointerEventData,
                UnityEngine.EventSystems.ExecuteEvents.initializePotentialDrag);
    ...
    internal static IEnumerator KeyDownLifeCycle(KeyCode keyCode, float power)
    {
        ...
        if (mouseKeyCodes.Contains(keyCode))
        {
            ...
            mouseTriggerInit(inputButton, out PointerEventData pointerEventData, out GameObject eventSystemTarget,
                out GameObject monoBehaviourTarget);
    ...
    {
        PointerEventData.InputButton[] inputButtons =
        {
    ...
    private static void mouseTriggerInit(PointerEventData.InputButton mouseButton,
        out PointerEventData pointerEventData, out GameObject eventSystemTarget, out GameObject monoBehaviourTarget)
    {
    ...
    private static void mouseDownTrigger(PointerEventData.InputButton mouseButton, PointerEventData pointerEventData,
        GameObject eventSystemTarget, GameObject monoBehaviourTarget)
    {
        ...
        pointerEventData.pointerPress = ExecuteEvents.ExecuteHierarchy(eventSystemTarget, pointerEventData,
            UnityEngine.EventSystems.ExecuteEvents.pointerDownHandler);
        ...
        {
            pointerEventData.pointerDrag = ExecuteEvents.ExecuteHierarchy(eventSystemTarget, pointerEventData,
    ...
    private static void mouseUpTrigger(PointerEventData.InputButton mouseButton, PointerEventData pointerEventData,
        GameObject eventSystemTarget, GameObject monoBehaviourTarget)
    {
        ...
        /* pointer/touch up */
        if (monoBehaviourTarget == monoBehaviourTargetMouseDown && mouseButton == PointerEventData.InputButton.Left &&
            monoBehaviourTarget != null)
        {
    ...
    {
        mouseTriggerInit(mouseButton, out PointerEventData pointerEventData, out GameObject eventSystemTarget,
            out GameObject monoBehaviourTarget);
    ...
    public static System.Collections.IEnumerator AccelerationLifeCycle(UnityEngine.Vector3 accelarationValue,
        float duration)
    {
        float timeSpent = 0;
        while (timeSpent < duration)
    ...
    private static UnityEngine.KeyCode ConvertStringToKeyCode(string keyName)
    {
        ...
        {
            return (UnityEngine.KeyCode) System.Enum.Parse(typeof(UnityEngine.KeyCode),
                System.Char.ToUpper(keyName[0]).ToString());
        }
        ...
        if (System.Text.RegularExpressions.Regex.Match(keyName, "joystick [1-8] button [0-9]{1,2}").Success)
        {
            ...
            return (UnityEngine.KeyCode) System.Enum.Parse(typeof(UnityEngine.KeyCode),
                "Joystick" + splitedString[1] + "Button" + number);
        }
